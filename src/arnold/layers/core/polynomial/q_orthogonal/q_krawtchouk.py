...
This module implements q-Krawtchouk polynomials :math:`K_n(x; p, N; q)`.

Mathematical Background
-----------------------
The q-Krawtchouk polynomials are the q-analog of classical Krawtchouk polynomials:
...
References
----------
.. [KLS] Koekoek et al. (2010), Chapter 14.15
"""
...
class QKrawtchouk(QPolynomialBase):
    ...
    Notes
    -----
    In the limit :math:`q \to 1`, q-Krawtchouk polynomials reduce to classical Krawtchouk polynomials.
