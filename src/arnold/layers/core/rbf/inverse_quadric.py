...
r"""
Inverse Quadric RBF Layer
=========================

Kolmogorov-Arnold Network layer using the Inverse Quadric radial basis function.
"""
...
@tfk.utils.register_keras_serializable(package="arnold", name="InverseQuadricRBF")
class InverseQuadricRBF(RBFBase):
    ...
    .. math::
        ...
        \phi(r) = \frac{1}{1+(\epsilon r)^{2}}, \quad r = \lVert x - x_{i} \rVert
