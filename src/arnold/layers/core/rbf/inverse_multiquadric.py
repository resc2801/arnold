...
r"""
Inverse Multiquadric RBF Layer
==============================
...
@tfk.utils.register_keras_serializable(package="arnold", name="InverseMultiQuadricRBF")
class InverseMultiQuadricRBF(RBFBase):
    ...
    .. math::
        ...
        \phi(r) = \frac{1}{\sqrt{1+(\epsilon r)^{2}}}, \quad r = \lVert x - x_{i} \rVert
